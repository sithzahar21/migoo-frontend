...
<Box dir="ltr">
    <Typography mt={4} mb={3} variant="body1">This part consists of sentences with a word or words missing in each. For each question,
    choose the answer 
    <Typography variant="h6" mt={1}>which best completes the sentence.</Typography>
    </Typography>
